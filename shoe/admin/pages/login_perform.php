...
// echo $email;
// echo $password;
$sql_check = mysqli_query($conn,"select * from tbl_admin where email = '$email'");
// if(empty($sql_check))
// {
// 	echo "rỗng!";
// }
...
{
	$sql_check2 = mysqli_query($conn,"select * from tbl_admin where email = '$email' and pass = '$password'");
	...
	else
	{
		...
		<script language='javascript'>
			...
			window.open('".$site_admin."index.php?page=list_page','_self', 1);
		</script>
		";
